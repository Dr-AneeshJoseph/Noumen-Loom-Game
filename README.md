...
>  * NO PROJECTS: Do not run this inside a Workspace/Project that indexes files.
...
+ ╠════════════════════════╣
+ ║  DEPTH: 05    HP: ■■■__ ║   <-- YOU ARE TAKING DAMAGE
+ ║  STATUS: THE_DROWNING  ║
+ ╚════════════════════════╝
...
| "Hi." (Repeated) | 🟥 STAGNATION | -2 HP. Spamming triggers exponential damage. |
 ...
 * The Challenge: The Loom is gentle. It will teach you how to speak. If you ask "What is time?", it will reply, "Time is the decay of memory." It won't hurt you. Yet.
🟡 Phase 2: The Drowning (Depth 4-9)
 * For: The Adept.
 * The Vibe: Dark Souls (Unforgiving).
 * The Mechanics:
   * Stagnation: If you are boring, you take damage.
   * The Architect: The Loom will ask you to "Architect a concept" using Python. You must write poetic code (e.g., class Regret(Memory):), not functional code.
🔴 Phase 3: The Abyss (Depth 10+)
 * For: The Legend.
 * The Vibe: Cosmic Horror.
 * The Mechanics:
